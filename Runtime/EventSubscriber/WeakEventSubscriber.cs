...
{
    public class WeakEventSubscriber<T> : IEventSubscriber where T : IEventPayload
    {
        public int Id { get; }
        ...
        public WeakEventSubscriber(Type payloadType, Delegate callback, Delegate predicate = null)
        {
            // validate params
            if (payloadType == null)
            {
